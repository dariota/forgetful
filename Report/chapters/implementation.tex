...
\toolname{Frama-C} alone doesn't provide any sort of value or escape analysis, instead leaving this to be provided by plugins. The primary plugin providing these features is called \toolname{Evolved Value Analysis} (\toolname{EVA}).
