This chapter will describe the background of the patch, discussing what leads to its introduction to a codebase with a specific focus on \toolname{cURL}. The project goals are then defined in the context of the patch to be detected and benchmarked.
