...
While \toolname{Frama-C} was a decent choice for its extensibility and availability of introductory guides to plugin development~\cite{framaplug}, finding assistance/documentation for it was relatively difficult, even for basic functionality of EVA.
...
\toolname{Frama-C}'s (open source) community is not hugely active, with only a few external plug-ins available~\cite{framapluglist}, and not many plug-ins having been created between its initial release a decade ago and now. In fact, the plugin list was last updated 5 years ago.
